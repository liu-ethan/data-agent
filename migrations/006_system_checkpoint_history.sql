-- System database (data_agent_system): immutable per-super-step checkpoint
-- history. runtime_checkpoints remains the optimistic-locking current
-- pointer used on the request hot path.
